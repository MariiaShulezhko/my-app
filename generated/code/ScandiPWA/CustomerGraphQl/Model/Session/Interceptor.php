...
class Interceptor extends \ScandiPWA\CustomerGraphQl\Model\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getDefaultTaxShippingAddress()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getDefaultTaxShippingAddress', func_get_args(), $pluginInfo) : parent::getDefaultTaxShippingAddress();
    }
    ...
    public function getDefaultTaxBillingAddress()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getDefaultTaxBillingAddress', func_get_args(), $pluginInfo) : parent::getDefaultTaxBillingAddress();
    }
